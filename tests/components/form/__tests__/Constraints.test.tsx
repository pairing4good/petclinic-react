...
describe('Constraints', () => {
  describe('NotEmpty', () => {
    it('should return message', () => {
      expect(Constraints.NotEmpty.message).toEqual('Enter at least one character')
    });
  ...
  describe('Digits', () => {
    it('should return message', () => {
      expect(Constraints.Digits(5).message).toEqual('Must be a number with at most 5 digits')
    });
